...
<br>
	<div class="container">
		...
		<div class="col-md-7">
			<textarea class="form-control" name="alamat_pelanggan" placeholder="Alamat pengiriman harus di isi lengkap, termasuk kota/kabupaten dan kode posnya." required ></textarea>
		</div>
		</div>
